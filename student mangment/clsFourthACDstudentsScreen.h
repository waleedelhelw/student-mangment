...
class clsFourthACDstudentsScreen:protected clsScreen
{
private:
...
public:
    static void ShowFourthAcdimicListScreen()
    {
        UpScreen("\t  Fourth ACD Students");

        vector<clsStudent::_stMaterials> vMaterials;
        vMaterials = clsStudent::GetListOfAcadimicStudentYear(4);
