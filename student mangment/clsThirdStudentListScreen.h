...
class clsThirdStudentListScreen:protected clsScreen
{
private:
...
public:
    static void ShowThirdAcdimicListScreen()
    {
        UpScreen("\t  Third ACD Students");

        vector<clsStudent::_stMaterials> vMaterials;
        vMaterials = clsStudent::GetListOfAcadimicStudentYear(3);
